...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Exoria Wiki',
    description: 'Exoria Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Exoria Wiki privacy',
      'data protection',
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Exoria Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@exoria.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@exoria.wiki</a>
            </p>
            <p>
