...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Exoria Wiki',
    description: 'Copyright and intellectual property information for Exoria Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Exoria Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Exoria Wiki',
      description: 'Copyright and intellectual property information for Exoria Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Exoria Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Exoria Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Exoria Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Exoria Developers</strong> - Creators of the Exoria game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Exoria</strong> - Trademark of the game developers</li>
              <li><strong>Exoria Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Exoria Wiki<br />
              Email: <a href="mailto:dmca@exoria.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@exoria.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Exoria Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Exoria Wiki (exoria.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@exoria.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@exoria.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@exoria.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@exoria.wiki</a>
            </p>
            <p>
